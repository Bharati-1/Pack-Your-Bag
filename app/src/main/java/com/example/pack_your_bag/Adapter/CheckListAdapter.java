...
public class CheckListAdapter extends RecyclerView.Adapter<CheckListViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CheckListViewHolder holder,int position) {
      ...
      if(myConstants.FALSE_STRING.equals(show)){
          ...
          holder.layout.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.borderlist));
      }else{
      ...
      holder.checkBox.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              if(myConstants.FALSE_STRING.equals(show)){
                  ...
                  Toast tostMessage = Toast.makeText(context, "", Toast.LENGTH_SHORT);
                if(tostMessage!=null){
                    tostMessage.cancel();
                }
//                if(itemsList.get(position).getChecked()){
//                    Toast.makeText(context, "("+holder.checkBox.getText()+")Packed", Toast.LENGTH_SHORT).show();
//                }else
